...
2. `docs/architecture.md` — system structure, boundaries, storage model, and invariants
3. `docs/ui-docs.md` — theme, colors, typography, and component conventions
...
If implementation changes the architecture, scope, or standards documented in the docs files, update the relevant file before continuing.